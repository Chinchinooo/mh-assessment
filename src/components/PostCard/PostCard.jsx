                ...
                <li className="list-none">
                  <div className="flex flex-shrink-0 p-4 pb-0">
                    <a href="#" className="flex-shrink-0 group block">
                      <div className="flex items-center">
                        <div>
                          <img 
                            className="inline-block h-10 w-10 rounded-full shadow-lg" 
                            src={user ? `https://robohash.org/${user.name}` : 'https://robohash.org/unknownuser'} 
                            alt="" 
                          />
                        </div>
                        <div className="ml-3">
                  ...
                  <div className="pl-16">
                    ...
                    <div className="flex items-center py-4">
                      <div className="flex-1 text-xs text-gray-500 hover:text-blue-400 transition duration-350 ease-in-out">
